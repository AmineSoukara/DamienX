...
if userge.has_bot:
    ...
    async def get_bot_pm_media() -> None:
        ...
        if not Config.BOT_MEDIA:
            _BOT_PM_MEDIA = get_file_id(await userge.bot.get_messages("damienot", 11))
            return
...
Nice To Meet You !, I'm <b>{bot_.fname}</b> A Bot.
        ...
        <b><i>Powered By</i> : [DAMIEN-X](https://t.me/DamienSoukara)
...
"""
        ...
        try:
            ...
            await message.reply_animation(animation=Config.PmImg, caption=start_msg, reply_markup=InlineKeyboardMarkup(btns), quote=True)
